...
<head>
    ...
    <title>La Katz ― Projects | Caroline Seiffert</title>
...
<body class="font-poppins">
    ...
    <div class="main h-full w-full  selection:text-[#eb9dff] selection:bg-[#146200]">
        ...
        <section class=" h-screen border-b border-[#9999996b]  relative bg-white   w-full flex flex-col">
            ...
            <img src="materials/e.webp" class="w-full h-[93%] lg:h-[80%] md:h-[85%] object-cover" alt="">
            ...
            <div
                ...
                <h4
                    ...
                    La Katz</h4>
                <p class="font-poppins  mix-blend-exclusion text-white  text-[0.75rem] sm:text-sm">September 2021</p>
        ...
        <section class="w-full h-full  bg-white ">
            ...
            <div class="  flex items-center justify-normal px-4  w-full py-16  border-b  border-[#9999996b] ">
                ...
                <h4
                    ...
                    Step into celestial elegance with LaKatz, where winter 2024 meets timeless sophistication.</h4>
            ...
            <div class="flex flex-col sm:flex-row mb-24  gap-y-24 sm:gap-y-0 sm:gap-x-24 mt-20  w-full h-full ">
                ...
                <div class="h-full   md:w-[50vw] flex flex-col gap-y-24">
                    ...
                    <img id="animation-opacity" src="materials/xlakatz.webp" class=" w-full h-full inline-block" alt="">
            ...
            <div
                ...
                <a href="/"
                    ...
                    <span class="text-xl mx-1 font-[200]">Go back</span>
                </a>
