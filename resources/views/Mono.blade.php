...
<head>
    ...
    <title>Mono ― Projects | Caroline Seiffert</title>
...
<body class="font-poppins">
    ...
    <div class="main h-full w-full bg-white  selection:text-[#eb9dff] selection:bg-[#146200]">


        <!-- nav goes here -->
        <header aria-label="Primary"
            class="fixed  group  z-40 flex h-[40px] lg:h-[40px]  w-full items-center bg-[#eb9dff]  ">
        ...
        <section class=" h-screen border-b border-[#9999996b]  relative bg-white   w-full flex flex-col">
            ...
            <img src="materials/f.webp" class="w-full h-[93%] lg:h-[80%] md:h-[85%] object-cover" alt="">
            ...
            <div
                ...
                <h4
                    ...
                    Mono</h4>
                <p class="font-poppins  mix-blend-exclusion text-white  text-[0.75rem] sm:text-sm">February 2021</p>
        ...
        <section class="w-full h-full  bg-white ">
            ...
            <div class="flex flex-col sm:flex-row mb-24  gap-y-24 sm:gap-y-0 sm:gap-x-24 mt-20  w-full h-full ">
                ...
                <div class="h-full   md:w-[50vw] flex flex-col gap-y-24">
                    ...
                    <img id="animation-opacity" src="materials/mono1.webp" class=" w-full h-full inline-block" alt="">

                    <img id="animation-opacity2" src="materials/mono2.webp" class="w-full inline-block h-full" alt="">
                ...
                <div class="h-full w-full gap-y-24 flex-col flex md:w-[50vw]">
                    ...
                    <img id="animation-opacity4" src="materials/mono3.webp" class="w-full h-full" alt="">
        ...
        <footer class="relative">
            ...
            <div
                ...
                <div class="flex flex-col text-[#999] h-full  w-full  items-center gap-y-2 xl:px-16 ">
                    ...
                    <small class="text-center text-[0.6125rem] opacity-100">© <!-- -->2025<!-- --> Caroline
                        Seiffert</small>
